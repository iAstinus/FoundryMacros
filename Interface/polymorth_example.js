 ...
 *
 * Proof of concept script for system agnostic
 * polymorphing/transforming. Intended for use
 * with dnd5e, but can be modified to suit your
 * system.
 *
 * Note: This script was written with the
 * dnd5e system in mind and utilizes some
 * of its properties as a shortcut (such
 * as not changing actor types).
 *
